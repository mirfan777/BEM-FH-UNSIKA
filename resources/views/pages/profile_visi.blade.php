...
<head>
    ...
    <title>BEM-KM FH UNSIKA - Visi, Misi, dan Tujuan</title>
    ...
    <main class="mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 my-20 md:mx-20">
        ...
        <div class="mb-8 sm:mb-12" data-aos="fade-up">
            <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">
                Visi, Misi, dan Tujuan BEM-KM FH Unsika
            </h1>
            <p class="text-base sm:text-base text-gray-700 leading-relaxed">
                Sebagai organisasi mahasiswa yang berperan dalam mengembangkan potensi, memperjuangkan aspirasi, serta menciptakan ruang kemahasiswaan yang inklusif, BEM-KM FH Unsika berkomitmen untuk menghadirkan kinerja terbaik demi kemajuan civitas akademika. Oleh karena itu, rumusan visi, misi, dan tujuan berikut disusun sebagai arah gerak organisasi agar setiap langkah yang ditempuh memiliki dasar yang jelas, terukur, dan berorientasi pada kesejahteraan bersama.
            </p>
        </div>
        ...
        <section class="mb-10 sm:mb-16" data-aos="fade-up" data-aos-delay="100">
            <div class="bg-white rounded-lg shadow-md p-6 sm:p-8 lg:p-10 border-l-4 border-red-700">
                ...
                <p class="text-base sm:text-base text-gray-700 leading-relaxed">
                    BEM-KM FH Unsika yang unggul dalam memperjuangkan keadilan inklusif untuk kesejahteraan dan pengembangan mahasiswa.
                </p>
            </div>
        </section>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 sm:p-8 lg:p-10">
                ...
                <div class="space-y-4 sm:space-y-5">
                    <div class="flex gap-3 sm:gap-4" data-aos="fade-right" data-aos-delay="300">
                        ...
                        <p class="text-gray-700 leading-relaxed text-sm sm:text-base pt-1">
                    ...
                    <div class="flex gap-3 sm:gap-4" data-aos="fade-right" data-aos-delay="550">
                        ...
                        <p class="text-gray-700 leading-relaxed text-sm sm:text-base pt-1">
                            Mendorong budaya kesejahteraan yang inklusif tanpa memandang latar belakang atau kepentingan.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="mb-10 sm:mb-16" data-aos="fade-up" data-aos-delay="600">
            <div class="bg-white rounded-lg shadow-md p-6 sm:p-8 lg:p-10">
                ...
                <div class="space-y-4 sm:space-y-5">
                    ...
                    <div class="flex gap-3 sm:gap-4" data-aos="fade-left" data-aos-delay="700">
                        <div class="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 bg-red-700 text-white rounded-full flex items-center justify-center font-bold text-sm sm:text-base">
                            2
                        </div>
                        <p class="text-gray-700 leading-relaxed text-sm sm:text-base pt-1">
                    ...
                    <div class="flex gap-3 sm:gap-4" data-aos="fade-left" data-aos-delay="750">
                        <div class="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 bg-red-700 text-white rounded-full flex items-center justify-center font-bold text-sm sm:text-base">
                            3
                        </div>
                        <p class="text-gray-700 leading-relaxed text-sm sm:text-base pt-1">
                    ...
                    <div class="flex gap-3 sm:gap-4" data-aos="fade-left" data-aos-delay="800">
                        <div class="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 bg-red-700 text-white rounded-full flex items-center justify-center font-bold text-sm sm:text-base">
                            4
                        </div>
                        <p class="text-gray-700 leading-relaxed text-sm sm:text-base pt-1">
                    ...
                    <div class="flex gap-3 sm:gap-4" data-aos="fade-left" data-aos-delay="850">
                        <div class="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 bg-red-700 text-white rounded-full flex items-center justify-center font-bold text-sm sm:text-base">
                            5
                        </div>
                        <p class="text-gray-700 leading-relaxed text-sm sm:text-base pt-1">
                            Mengupayakan kesejahteraan yang inklusif, tanpa memandang latar belakang atau kepentingan, demi menciptakan lingkungan kampus yang harmonis.
                        </p>
                    </div>
                </div>
            </div>
